...
<div class="container mx-auto px-6 py-8 font-sans space-y-8">
    ...
    <div class="mb-6 border-b pb-4">
        <h1 class="text-3xl font-bold text-teal-700">Dashboard Bidan</h1>
        ...
        <div class="mt-4 flex items-center gap-4">
            ...
            <div>
                <h2 class="text-lg font-bold text-teal-700">{{ auth()->user()->name }}</h2>
        ...
        .then(data => {
            if(data.success){
                ...
                formsContainer.innerHTML += `
                    <form action="/dokter/bidan/selesai/${id}" method="POST" 
