...
<div class="container mx-auto px-6 py-8 font-sans space-y-8">
    ...
    <div class="mb-6 border-b pb-4">
        <h1 class="text-3xl font-bold text-teal-700">Dashboard Dokter Umum</h1>
        ...
        .then(data => {
            if(data.success){
                ...
                formsContainer.innerHTML += `
                    <form action="/dokterumum/selesai/${id}" method="POST" 
